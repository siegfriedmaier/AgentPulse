...
#[derive(Debug)]
pub struct AgentPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AgentPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AgentPulse processing");
    
    let mut processor = AgentPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AgentPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AgentPulseProcessor::new(false);
